      ...
      <div className="relative container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h1 className="text-5xl md:text-6xl font-bold tracking-tight bg-gradient-to-r from-slate-900 via-blue-900 to-purple-900 bg-clip-text text-transparent mb-6">
              Recomendador de
              <br />
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 p-8 md:p-12">
            <Tabs defaultValue="natural" className="w-full">
              <TabsList className="grid w-full grid-cols-2 mb-12 h-14 p-1 bg-slate-100">
          ...
          <div className="text-center mt-16">
            <p className="text-slate-500 text-sm">
              Creado por <span className="font-semibold text-slate-700">Cristian Parada</span> con ❤️ para
              desarrolladores que buscan el stack perfecto
            </p>
          </div>
        </div>
      </div>
